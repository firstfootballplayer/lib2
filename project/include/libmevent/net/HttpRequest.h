...
#ifndef libmevent_NET_HTTP_HTTPREQUEST_H
#define libmevent_NET_HTTP_HTTPREQUEST_H
...
class HttpRequest : public libmevent::copyable {
public:
...
#endif // libmevent_NET_HTTP_HTTPREQUEST_H
